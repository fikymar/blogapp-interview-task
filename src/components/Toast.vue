    ...
    <div class="flex p-4 items-center gap-5">
      ...
      <div class="ml-auto">
        <button
          @click="deleteMessage"
          type="button"
          class="inline-flex flex-shrink-0 justify-center items-center h-4 w-4 rounded-md text-zinc-100 hover:scale-110 transition-transform duration-500 text-sm"
        >
